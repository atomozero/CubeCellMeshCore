...
//#define SILENT                    // Disable serial output for minimum power
...
//=============================================================================
    ...
    #define TAG_ADVERT  "[ADVERT]"
    #define TAG_AUTH    "[AUTH]"
    #define TAG_DISCOVERY "[DISC]"
    #define LOG(...)
    #define LOG_RAW(...)
...
#define EEPROM_VERSION      3           // Config version (3 = added daily report)
...
#define BOOT_SAFE_PERIOD_MS  10000  // 10 seconds
uint32_t bootTime = 0;
